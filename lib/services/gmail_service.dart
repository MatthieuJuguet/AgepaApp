...
class GmailService {
  ...
  static const _clientId = 'VOTRE_CLIENT_ID_ICI';
  static const _clientSecret = 'VOTRE_CLIENT_SECRET_ICI';
  ...
  static Future<void> sendOrDraft({
    ...
    final rawMessage = await _createMimeMessage(recipient, subject, body, attachment);
  ...
  static Future<String> _createMimeMessage(String to, String subject, String bodyText, File pdfFile) async {
    ...
    for (int i = 0; i < pdfBase64.length; i += 76) {
      mime.writeln(pdfBase64.substring(i, i + 76 > pdfBase64.length ? pdfBase64.length : i + 76));
    }
